# This example is an adaptation of the program wavy_message.py from the pimoroni-pico tufty2040 repository for the Pimoroni Explorer
...
message = "Pimonori Explorer is a hackable, programmable board with a TFT LCD colour display, powered by the Raspberry Pi RP2050!"
text_size = 10
