# This example is an adaptation of the program from the pimoroni-pico tufty2040 repository for the Pimoroni explorer
# Mainly import statement and buttons configuration and usage
import time
import random
from explorer import button_a,button_b,button_c,button_z
