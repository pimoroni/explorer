# This example is an adaptation of the program clock.py from the pimoroni-pico tufty2040 repository for the Pimoroni explorer

# Button Z : set time toggle
# Button A : toggle selection
# Button B : toggle selection
# Button X : increment hours or minutes based on selection
# Button Y : decrement hours or minutes based on selection

import time
import machine
from explorer import button_a, button_b, button_z, button_x, button_y, display
...
button_z.irq(trigger=machine.Pin.IRQ_RISING, handler=button)
