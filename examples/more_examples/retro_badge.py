...
# Copy your image to your Explorer alongside this example - it should be a 120 x 120 jpg.
# This example is an adaptation of the program retro_badge.py from the pimoroni-pico tufty2040 repository for the Pimoroni Explorer

from explorer import display,button_c
...
NAME = "M. 'Explorer'"
BLURB1 = "RP2050 plus 320x240 TFT LCD"
BLURB2 = "Nuts From Trees collector"
BLURB3 = "Will work for peanuts"

QR_TEXT = "pimoroni.com/explorer"
